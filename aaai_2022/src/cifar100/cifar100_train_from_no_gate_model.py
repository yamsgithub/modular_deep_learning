...
parser.add_argument('-ot', help='output model type')
...
working_path = '/nobackup/projects/bdrap03/yamuna/modular_deep_learning/aaai_2022'
...
train_from_no_gate_model(m, k=k, model_name=mt, out_model_name=ot, 
                         ...
                         trainloader=cifar100_trainloader, testloader=cifar100_valloader, 
