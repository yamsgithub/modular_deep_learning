...
from cifar100_original_moe_training_hidden256 import *
...
def train_from_model(m, num_epochs, num_classes, total_experts, w_importance=0.0, 
    ...
    plot_file = generate_plot_file(m, temp=T[0], w_importance=w_importance, w_sample_sim_same=w_sample_sim_same,w_sample_sim_diff=w_sample_sim_diff,specific=str(num_classes)+'_'+str(total_experts)+'_models.pt')
